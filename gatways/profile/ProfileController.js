...
class ProfileController {
  ...
  async profileImage({ body, pathParameters }) {
    try {
      ...
      const documentExists = await this.service.findByDocument({ document: document });
      ...
      const saveDbImageLink = await this.service.setUrlImageProfile({ document: document, profileImage: imageUrl });
