"use strict";
const {  IVideo } = require("../gatways/videos/IVideo");
const VideoModel = require("../entitys/videos");
const uuid = require('uuid');
const bcrypt = require('bcrypt')

module.exports = class IVideoRepository {
  ...
  async countVideosPerSession({sessionId}) {
